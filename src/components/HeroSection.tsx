  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-36">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="hero-lightning bg-black/60 backdrop-blur-xl border border-white/20 rounded-3xl p-8 md:p-12 shadow-2xl mt-8 md:mt-16 lg:mt-24 overflow-hidden">
          ...
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight">
              ...
              <br />
              <span className="gradient-patriotic bg-clip-text text-transparent font-extrabold">
                Print Solutions
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                size="xl"
                className="group bg-primary hover:bg-primary/90 text-white font-bold shadow-premium"
                asChild
              >
                <a
                  href="/premadedesigns"
              ...
              <Button size="xl" className="bg-accent hover:bg-accent/90 text-white font-bold shadow-red-glow" asChild>
                <a href="https://www.instagram.com/tdstudiosco/" target="_blank" rel="noopener noreferrer">
                  DM TO GET STARTED
                </a>
              </Button>
            </div>
